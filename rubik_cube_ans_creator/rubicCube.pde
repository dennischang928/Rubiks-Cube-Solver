class rubikCube { //<>// //<>//
  ...
  boolean isGroup0() {
    return isGroup0(this);
  }

  boolean isGroup0(rubikCube _r) {
    boolean ans = true;

    ans &= _r.face[0].rubik_color[1][1].rubik_color == 'W';
    ans &= _r.face[1].rubik_color[1][1].rubik_color == 'O';
    ans &= _r.face[2].rubik_color[1][1].rubik_color == 'G';
    ans &= _r.face[3].rubik_color[1][1].rubik_color == 'R';
    ans &= _r.face[4].rubik_color[1][1].rubik_color == 'B';
    ans &= _r.face[5].rubik_color[1][1].rubik_color == 'Y';
  ...
  void Write_Color(String input) {
    int start = 0;
    int end = 9;
    for (int i = 0; i<6; i++) {
      face[i].Write_Color(input.substring(start, end));
      println(end);
      start = start+ 9;
      end = end + 9;
    }
